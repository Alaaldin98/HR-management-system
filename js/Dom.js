...
mains.appendChild(title);


let namesDiv = document.getElementById("names");

let namesTag = document.createElement("h3");

salaryTag.textContent = "1000$";

namesDiv.appendChild(namesTag);
...
let mainsection = document.createElement("h2");
let title
// let mainsection = document.getElementById("info")
let img = document.createElement ("img")
img.setAttribute("src" , "https://post.healthline.com/wp-content/uploads/2020/08/full-moon-night-landscape-732x549-thumbnail-1-732x549.jpg")
mainsection.appendChild(img)
